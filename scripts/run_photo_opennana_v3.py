# Re-post 12 photos with CORRECT per-image URLs
...
# 12 images: (url, lang, caption) - each URL is unique and correct
images = [
    ...
    ("ko", "열대 리조트의 오후, Y2K 스타일의 여유. 자연광이 만들어내는 그림자가 매력적이야.",
     "https://img.opennana.com/prompts/assets/202608/1787152548955-60qt3ook-1787152551779-1.jpg"),
    ("ko", "중식당에서의 스냅, 펑크와 전통의 조화. 플래시 촬영의 생생함이 좋아.",
     "https://img.opennana.com/prompts/assets/202608/1787152564446-vr494uem-1787152567129-1.jpg"),
    ("ja", "独り暮らしの廊下、毛布を抱えて。静かな日常の一コマ。",
     "https://img.opennana.com/prompts/assets/202608/1787152567706-r30x8wto-1787152570317-1.jpg"),
    ("en", "Luxury lounge seated portrait — the teal velvet chair and deep pink dress create such a moody atmosphere.",
     "https://img.opennana.com/prompts/assets/202608/1787152546268-m7pnujlv-1787152548970-1.jpg"),
    ("en", "High-angle bedroom portrait — the light hitting the jumpsuit texture is everything.",
     "https://img.opennana.com/prompts/assets/202608/1787152916234-gx2qpv05-1787152919016-1.jpg"),
    ("en", "Clean studio lighting, black jumpsuit silhouette. Sometimes the simplest outfits make the strongest portraits.",
     "https://img.opennana.com/prompts/assets/202608/1787152556975-6h498uaw-1787152559590-1.jpg"),
    ("en", "Wide-angle upper body study — the perspective distortion adds character to the composition.",
     "https://img.opennana.com/prompts/assets/202608/1787152922861-jfkc0rht-1787152925496-1.jpg"),
    ("en", "Brooklyn Bridge morning mist, white cardigan layered over dark tones. That Japanese photobook aesthetic never gets old.",
     "https://img.opennana.com/prompts/assets/202608/1787152542308-qvfuz885-1787152545259-1.jpg"),
    ("ja", "コンクリートの台座、硬い光。ストリートポートレートの醍醐味。",
     "https://img.opennana.com/prompts/assets/202608/1787152541958-hemxad51-1787152544784-1.jpg"),
    ("ja", "緑のシェードと制服、都会の隅。若さと静けさが交差する瞬間。",
     "https://img.opennana.com/prompts/assets/202608/1786976086540-c32liy8y-1786976089414-1.jpg"),
    ("ja", "ネオンの夜、黒真珠の輝き。CCDフィルムのような色合いが好き。",
     "https://img.opennana.com/prompts/assets/202608/1786976082501-bmjzhe3u-1786976085143-1.jpg"),
]
...
moments = []
for i, (lang, caption, img_url) in enumerate(images):
...
out_csv = ROOT / "moments_photo_lang_v3.csv"
...
for i, m in enumerate(moments):
    ...
    print(f"  [{i+1}] {acct['昵称']:15} lang={m['_lang']} | {m['content'][:50]}")
